//=================================================================================
//	プログラム名	：	
//	処理			：	1/4バッファにサイズダウン[shaderDownPassFiltter.cpp]
...
// 初期化関数
//=================================================================================
HRESULT CSDownPassFilter::Init(void)
{
	...
	if (FAILED(D3DXCompileShaderFromFile("data/HLSL/DownPassFilter_ps.hlsl", NULL, NULL, "main", "ps_3_0", 0, &code, &err, &m_pPConstantTable))) {
...
// 終了関数
//=================================================================================
void CSDownPassFilter::Uninit(void)
{
}
...
// 描画開始関数
//=================================================================================
void CSDownPassFilter::Begin(void)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
...
// 値設定関数
//=================================================================================
void CSDownPassFilter::SendData(LPDIRECT3DTEXTURE9 pTexture)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
...
// 描画関数
//=================================================================================
void CSDownPassFilter::Draw(float mag)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
...
// 描画終了関数
//=================================================================================
void CSDownPassFilter::End(void)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
...
// テクスチャに書き込む
//=================================================================================
void CSDownPassFilter::Fillter(LPDIRECT3DSURFACE9 surface, LPDIRECT3DTEXTURE9 pTexture, float mag)
{
	Begin();
	SendData(pTexture);
