//=================================================================================
//	プログラム名	：	
//	処理			：	水平方向ブラー[shaderHorizonalBlurFiltter.cpp]
...
// 初期化関数
//=================================================================================
HRESULT CSHorizontalBlurFilter::Init(void)
{
	...
	if (FAILED(D3DXCompileShaderFromFile("data/HLSL/HorizontalBlurFilter_ps.hlsl", NULL, NULL, "main", "ps_3_0", 0, &code, &err, &m_pPConstantTable))) {
...
// 終了関数
//=================================================================================
void CSHorizontalBlurFilter::Uninit(void)
{
}
...
// 描画開始関数
//=================================================================================
void CSHorizontalBlurFilter::Begin(void)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
	pDevice->SetSamplerState(0, D3DSAMP_ADDRESSU, D3DTADDRESS_MIRROR); // テクスチャＵ値の繰り返し設定(変更)
...
// 値設定関数
//=================================================================================
void CSHorizontalBlurFilter::SendData(LPDIRECT3DTEXTURE9 pTexture, float mag)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
	float width = (float)SCREEN_WIDTH * mag;
	m_pPConstantTable->SetValue(pDevice, "SCREEN_WIDTH", &width, sizeof(width));
...
// 描画関数
//=================================================================================
void CSHorizontalBlurFilter::Draw(float mag)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
...
// 描画終了関数
//=================================================================================
void CSHorizontalBlurFilter::End(void)
{
	LPDIRECT3DDEVICE9 pDevice = CRenderer::GetDevice();
...
// テクスチャに書き込む
//=================================================================================
void CSHorizontalBlurFilter::Fillter(LPDIRECT3DSURFACE9 surface, LPDIRECT3DTEXTURE9 pTexture, float mag)
{
	Begin();
